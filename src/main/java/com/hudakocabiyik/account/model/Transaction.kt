...
package com.hudakocabiyik.account.model
...
data class Transaction(
    ...
    constructor() : this(id = null, transactionType = TransactionType.INITIAL, amount = BigDecimal.ZERO, transactionDate = LocalDateTime.now(), account = null)
